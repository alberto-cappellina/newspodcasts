...
def test_text_split_into_multiple_chunks() -> None:
    word = "a" * 100
...
def test_no_word_is_broken() -> None:
...
def test_all_words_preserved() -> None:
...
def test_single_word_exceeding_limit() -> None:
    long_word = "x" * 5000
